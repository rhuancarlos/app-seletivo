...
(function( $, window, document, undefined ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var filter = $('<div/>', {
			...
			.append( $('<label/>' ).append( str ) ).append( $(iconRefresh).append($(classes.sFilter)) ).append( $(iconSearchAdvanced).append($(classes.sFilter)) );
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 */
			"sSearchPlaceholder": "O que você esta procurado ?",
