...
$(function () {
  ...
  // DESATIVADO ->> USANDO O bootstrap-datepicker
  ...
  $('.floated-colors-btn').on('click', function () {
    if ($('body').hasClass('color-scheme-dark')) {
      //$('.menu-w').removeClass('color-scheme-dark').removeClass('selected-menu-color-bright').addClass('selected-menu-color-light');
      $('.menu-w').removeClass('selected-menu-color-bright').addClass('selected-menu-color-light');
      ...
      $('.menu-w').removeClass('selected-menu-color-bright').removeClass('color-scheme-light').addClass('color-scheme-dark').addClass('sub-menu-color-light').addClass('menu-position-side').addClass('menu-side-left').addClass('menu-layout-compact');
      ...
      //MUDANDO A LÓGICA P/ QUANDO FOR REMOVIDO O MODO NOTURNO VOLTAR P/ O TIPO DARK : DEPOIS FAZER UMA FUNÇÃO PRA RESOLVER ISSO
