<ul class="nav nav-tabs">
  <li class="nav-item active"><a data-toggle="tab" class="nav-link active" href="#dados_prova">Dados da Prova</a></li>
...
<div class="tab-content element-box">
  <div id="dados_prova" class="tab-pane fade in active show">
    ...
    <?php require(VIEW_MODULO_PROVAS.'r_inputs_prova_dados.php')?>
  </div>
  <div id="detalhamento" class="tab-pane fade">
    <!-- Inputs Form@dados_outros -->
    <?php require(VIEW_MODULO_PROVAS.'r_inputs_prova_detalhamento.php')?>
  </div>
