...
class Equipe extends MY_Controller {
	...
	public function index() {
		//debug_array(getTabelasComPermissaoDeAcesso_ByGrupoAcessoId($this->seguranca->dec($this->rsession->get('usuario_logado')['grupo_usuario_id'])));
		//$permissao_modulo = getTabelasComPermissaoDeAcesso_ByGrupoAcessoId($this->seguranca->dec($this->rsession->get('usuario_logado')['grupo_usuario_id']));
		$this->permissoes->verificaAcesso($this->tabela_id_r, $this->seguranca->dec($this->rsession->get('usuario_logado')['grupo_usuario_id']));
		//$acesso_edicao = $this->permissoes->verificaAcesso($this->tabela_id_u, $this->seguranca->dec($this->rsession->get('usuario_logado')['grupo_usuario_id']));
