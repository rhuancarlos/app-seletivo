              ...
              <div class="form-wrapper animate-if" ng-if="screenStage == 3">
                <div class="row">
                  <div class="content-section" style="width: 100%;">
                    ...
                    <div class="form-group">
                      <label for="colegio_atual">Como ficou sabendo ? *</label>
                      <select name="como_ficou_sabendo" id="como_ficou_sabendo" class="form-control" required ng-model="dadosAgendamento.dados_pessoais.como_ficou_sabendo">
                        <option value=""> Escolha uma opção</option>
                        <option value="Redes Sociais"> Redes Sociais</option>
                        <option value="Tv/Rádio"> Tv/Rádio</option>
                        <option value="Panfletos/Outdoors"> Panfletos/Outdoors</option>
